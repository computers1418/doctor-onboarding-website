      ...
      children: [
        ...
        Padding(
            padding: EdgeInsets.only(
                bottom: height < 650 ? 8 : 25, top: height < 650 ? 0 : 10),
            child: Text("It's A Pleasure To Have You Join Us.",
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: Theme.of(context)
                  ...
                  .hintStyle!
                  .copyWith(
                      fontSize: TextResponsive.get(context, 14), height: 1),
            ),
          ),
        ),
        SizedBox(
        ...
        SizedBox(
          height: 60,
          child: TextField(
            controller: loginController.onboardingController,
            style: TextStyle(
              height: 1,
              fontSize: TextResponsive.get(context, 14),
            ),
